...
version = zunui_ver.version_info.version_string()
# The full version, including alpha/beta/rc tags.
release = zunui_ver.version_info.release_string()
...
repository_name = 'openstack/zun-ui'
bug_project = 'zun-ui'
bug_tag = ''
...
# [howto/manual]).
latex_documents = [
    ('index', 'doc-zun-ui.tex', u'Zun UI Documentation',
...
man_pages = [
    ('index', u'Zun UI Documentation',
     'Documentation for the Zun UI plugin to the Openstack\
      Dashboard (Horizon)',
     [u'OpenStack'], 1)
]
